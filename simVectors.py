...
class MainWindow(QMainWindow):
    ...
    def eventUpdateEmotion(self, val):
        emotions = {"joy": self.joy, "anger": self.anger, "fear": self.fear, "disgust":self.disgust, "surprise":self.surprise}
